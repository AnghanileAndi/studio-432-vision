...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium multimedia studio in Greater Noida offering recording, photography, videography, and creative production for modern artists and brands." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress: "H-93, Block H, Beta II",
